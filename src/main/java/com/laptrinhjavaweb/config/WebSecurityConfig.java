...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
                http.csrf().disable()
                .authorizeRequests()
                        .antMatchers(HttpMethod.GET ,"/admin/building").authenticated()
                        .antMatchers(HttpMethod.DELETE ,"/api/building").hasRole("MANAGER")
                        .antMatchers(HttpMethod.GET, "/admin/building-edit").hasRole("MANAGER")
                        .antMatchers("/admin/building-edit-**").authenticated()
                        .antMatchers(HttpMethod.GET, "/admin/customer").authenticated()
                        .antMatchers(HttpMethod.DELETE, "/api/customer").hasRole("MANAGER")
                        .antMatchers(HttpMethod.GET,"/admin/customer-edit").hasRole("MANAGER")
